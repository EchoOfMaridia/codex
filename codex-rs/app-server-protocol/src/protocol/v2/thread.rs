...
pub struct ThreadStartParams {
    ...
    /// Omitted defaults a new thread to `explicitRequestOnly`.
...
pub struct ThreadStartResponse {
    ...
    /// Effective model-visible multi-agent mode. `null` when multi-agent mode
    /// prompting is not applicable to this thread.
    #[experimental("thread/start.multiAgentMode")]
    #[serde(default)]
    pub multi_agent_mode: Option<MultiAgentMode>,
}
